...
// Ревизия оболочки: r1 — правки от 20.09.2026 (статус оплаты в карточке
// заявки, подписи в окне «🚚 Доставлено на объект», понятное сообщение о
// неприменённой миграции базы).
