...
const DICT = {
    ru: {
        ...
        'order.invoiceHint': 'Загрузите фото или скан счёта и заполните цены по позициям. После сохранения счёт появится на рабочем столе финансиста в блоке «Счета на материалы».',
    ...
    uk: {
        ...
        'order.invoiceHint': 'Завантажте фото або скан рахунку та заповніть ціни за позиціями. Після збереження рахунок зʼявиться на робочому столі фінансиста в блоці «Рахунки на матеріали».',
