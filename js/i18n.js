...
const DICT = {
    ru: {
        ...
        'order.invoiceHint': 'Загрузите фото или скан счёта, заполните цены по позициям и укажите стоимость доставки: она входит в итог счёта и попадает в «Реестр материалов» отдельной строкой. После сохранения счёт появится на рабочем столе финансиста в блоке «Счета на материалы», а заявка перейдёт в «Ожидает оплаты».',
        ...
        // пустое поле — доставки нет, строка удаляется из заявки.
        'order.invoiceDelivery': '🚚 Стоимость доставки (грн)',
        'order.invoiceDeliveryHint': 'Если поставщик привёз материалы за отдельную плату — впишите сумму. Строка «🚚 Доставка» появится в заявке и в «Реестре материалов» отдельной категорией. Пусто — доставки нет.',
    ...
    uk: {
        ...
        'order.invoiceHint': 'Завантажте фото або скан рахунку, заповніть ціни за позиціями та вкажіть вартість доставки: вона входить у підсумок рахунку й потрапляє до «Реєстру матеріалів» окремим рядком. Після збереження рахунок зʼявиться на робочому столі фінансиста в блоці «Рахунки на матеріали», а заявка перейде в «Очікує оплати».',
        ...
        'order.invoiceDelivery': '🚚 Вартість доставки (грн)',
        'order.invoiceDeliveryHint': 'Якщо постачальник привіз матеріали за окрему плату — впишіть суму. Рядок «🚚 Доставка» зʼявиться в заявці та в «Реєстрі матеріалів» окремою категорією. Порожньо — доставки немає.',
