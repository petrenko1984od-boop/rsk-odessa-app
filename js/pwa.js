// =====================================================================
// RSK ODESSA — PWA: УСТАНОВКА ПРИЛОЖЕНИЯ И ОБНОВЛЕНИЕ ВЕРСИИ
// =====================================================================
...
//   2) показываем карточку «Установить RSK Odessa» (#pwa-install-banner),
...
function setupInstallOffer() {
    ...
    if (isIOS()) {
        ...
        setText('pwa-install-text',
            ...
            'Значок RSK появится на рабочем столе, приложение откроется без адресной строки.');
