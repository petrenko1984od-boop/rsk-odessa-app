...
// =====================================================================
// Приложение по умолчанию красное: фирменный красный логотипа (#c8102e) стоит
// и в `:root` файла css/theme.css, поэтому до первой отрисовки JS интерфейс не
// «мигает» чужим цветом. В «Настройках» сотрудник выбирает свой цвет: выбор
// хранится в localStorage устройства и ни на кого не влияет.
//
...
// набор значений этих переменных для html[data-theme="..."]. Те же переменные
// рисуют меню (`.nav-surface`, `.nav-chip`, `.nav-cta`): цвет схемы там работает
// рамкой, разделителем и акцентом, а поверхности остаются белыми. Поэтому новая
